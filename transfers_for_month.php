...
$sales = find_by_sql("SELECT sucursal As Sucursal, SUM(total) As Total, SUM(valor_costo) As VCosto, SUM(piezas) As Piezas, SUM(valor_venta) As VVenta, MONTH(fecha) AS Mes 
FROM traspasos WHERE fecha  >= '{$request_date_start}' AND fecha  <= '{$request_date_end}'
                                ...
                                <table class="table table-striped table-hover" id="tableExport" class="table table-striped" id="table-1" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                              ...
                                              <td>$<?= number_format($item["VCosto"], 2) ?></td>
