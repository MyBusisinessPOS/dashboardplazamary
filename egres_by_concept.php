...
session_start();
ob_start();
$page_title = 'Reporte detallado de gastos por sucursal';
...
$sales = find_by_sql("SELECT concepto, descripcion, importe, usuario, fecha, hora, sucursal  
FROM egresos  WHERE sucursal LIKE '{$request_branch}' AND fecha  >= '{$request_date_start}' AND fecha  <= '{$request_date_end}' ", true);
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Reporte detallado de gastos por sucursal</h4>
                        </div>
                        <div class="card-body">
