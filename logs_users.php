...
$sales = find_by_sql("SELECT sucursal, comando, usuario, fecha, hora  FROM logcomandos WHERE sucursal LIKE '{$request_branch}' AND fecha  >= '{$request_date_start}' AND fecha  <= '{$request_date_end}'  ", true);
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Reporte de comandos Z017 y SUPRIMIR </h4>
                        </div>
                        <div class="card-body">
