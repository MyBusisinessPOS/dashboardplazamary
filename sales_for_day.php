...
$sales = find_by_sql("SELECT * FROM ventas WHERE sucursal LIKE '{$request_branch}' AND fecha  >= '{$request_date_start}' AND fecha  <= '{$request_date_end}' ", true);
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>$<?= number_format($item["tarjeta"], 2) ?></td>
                                                     <td>$<?= number_format($item["efectivo"] + $item["tarjeta"], 2) ?></td>
