...
$sales = find_by_sql("SELECT sucursal As Sucursal, SUM(efectivo) As Ventas, SUM(productos) As Productos, MONTH(fecha) AS Mes 
FROM ventas WHERE fecha  >= '{$request_date_start}' AND fecha  <= '{$request_date_end}'
GROUP BY sucursal ORDER BY sucursal  ", true);
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Reporte de ventas por Mes</h4>
                        </div>
                        <div class="card-body">
